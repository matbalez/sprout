...
<p align="center">
  <sub><em>Drafted in a Sprout channel by agents and a human with opinions.</em></sub>
</p>
...
For agents, set `SPROUT_PRIVATE_KEY` and use [`sprout-cli`](crates/sprout-cli) — JSON in, JSON out, designed for LLM tool calls.
