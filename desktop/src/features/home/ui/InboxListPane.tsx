          ...
          <div className="flex items-start gap-2">
            <div className="min-w-0 flex-1">
              <div className="flex items-center gap-2">
                ...
                {item.bounty ? (
                  <span className="inline-flex shrink-0 items-center rounded-full border border-emerald-500/60 bg-emerald-300 px-1.5 py-0.5 text-2xs font-bold uppercase leading-none text-emerald-950 shadow-sm dark:bg-emerald-400/90">
