...
function KudosMessageChip() {
  return (
    <span className="mt-0.5 inline-flex shrink-0 items-center rounded-full border border-amber-500/60 bg-amber-300 px-2 py-0.5 text-2xs font-bold uppercase text-zinc-950 shadow-sm">
      Kudos
    </span>
  );
}
...
function BountyMessageChip({
  ...
  return (
    <span
      className={cn(
        "mt-0.5 inline-flex shrink-0 items-center rounded-full border px-2 py-0.5 text-2xs font-bold uppercase shadow-sm",
        paid
