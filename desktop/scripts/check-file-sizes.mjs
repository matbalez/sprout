...
const overrides = new Map([
  ...
  // Mainline restore/watchdog handling and activity-feed avatar_url plumbing
  // add the latest overage.
  ...
  // Rebase merge carries production install-planning plus branch shared-agent
  // owner resolution in the same command boundary.
  ["src-tauri/src/commands/agent_discovery.rs", 1537],
