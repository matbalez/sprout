...
const overrides = new Map([
  ...
  // rest of this list.
  ["src-tauri/src/commands/channels.rs", 1047],
  ...
  // Bitcoin branch payment toolset defaults add wallet broker env wiring in
  // the same spawn path. Queued to split.
  ["src-tauri/src/managed_agents/runtime.rs", 2075],
  ...
  ["src-tauri/src/app_state.rs", 1018],
]);
